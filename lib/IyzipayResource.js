...
IyzipayResource.prototype._getHttpHeaders = function (method) {
    ...
    headers[IyzipayResource.CLIENT_VERSION] = "iyzipay-node-2.0.28";
...
IyzipayResource.prototype._preparePath = function (method) {
    ...
    Object.keys(pathVariables).map(function (key) {
...
IyzipayResource.prototype.retrieveAll = function (params, cb) {
    this._config.body = params;
    this._request(utils.apiMethod.RETRIEVE_ALL, function (err, res, body) {
        cb(err, body);
    });
};
